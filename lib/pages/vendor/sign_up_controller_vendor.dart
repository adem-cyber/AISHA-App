...
class SignUpControllerVendor extends GetxController {
  ...
  Future<void> registerUser(String email, String password) async {
    AuthenticationRepoVendor.instance.createUserWithEmailAndPassword(email, password);
  }
  ...
  try {
    ...
    if (isVerified) {
      ...
      Get.to(() => const OTPScreenVendor());  // Navigate to the OTPScreen or any other screen as needed
    } else {
