          ...
          SliverAppBar(
            ...
            title: Row(
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                    Get.to(()=>  OrderReceivedVendor(storeid: selectedStoreData.getStoreid(),));
                    },
                     child: Stack(
              ...
              children: [
                Container(
                  child: FutureBuilder<List<ProductsModelVendor>>(
                    future: controller.getallGrocery(selectedStoreData.getStoreid()),
  ...
  final snackBar = SnackBar(
    ...
    action: SnackBarAction(
      ...
      onPressed: () {
        ...
        controller.deleteProduct(product.data![index].id);
         _refreshData();
  ...
  color: Colors.redAccent,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  if (product.data![index].available == "Available")
    BigText(
      text: "${product.data![index].available}",
      color: AppColors.button1, // Change the color to green for available
      size: 15,
    )
    ...
    BigText(
      text: "${product.data![index].available}",
      color: AppColors.paracolor, // Change the color to red for unavailable
      size: 15,
    ),
    ...
    'Availability':availability
                                                  ...
                                                  await _db
     .collection("Products").doc(product.data![index].id)
     .update(itemData);
                                     _refreshData();                
                                                    },
                                                   child: Icon(
  product.data![index].available == "Available"
      ? Icons.check_circle
      : Icons.cancel,
  color: product.data![index].available == "Available"
      ? Colors.green
      : Colors.purple,
),
                                                  ),
            ...
            context,
            MaterialPageRoute(
               builder: (context) => EditProduct(storeid: selectedStoreData.getStoreid() ,
               name:product.data![index].name, description:product.data![index].description,
               price: product.data![index].price, id: product.data![index].id, image: product.data![index].image,  ), // Pass storeid as an argument
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
               builder: (context) => AddProductPage(storeid: selectedStoreData.getStoreid()), // Pass storeid as an argument
